                ...
                <div class="col-lg-9 main-chart">
                      ...
                      <div class="border-head">
                        <?php include('submenu.php');?>
                         <h3 class="float_left"> Orders already executed </h3>
                      </div>
            ...
            <table style="background-color:#FFF" class="table table-bordered table-striped table-condensed">
                             <thead>
                              <tr>
                                  ...
                                  <th width="28" >Supplied</th>
                                   <th width="42" >Delivery by</th>
                                  <th width="58" class="numeric">Options</th>
                              </tr>
                             </thead>
                             <tbody>
                            <?php $i=1; $q=mysql_query("SELECT * FROM `tbl_orders` where status=1 order by order_id desc ") or die(mysql_error());
