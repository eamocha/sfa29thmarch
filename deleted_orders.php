...
<html lang="en">
  <head>
    ...
    <![endif]--> <?php require 'header.php';   $uid=clean($_SESSION['u_id']);
                ...
                <div class="col-lg-9 main-chart">
                      ...
                      <div class="border-head">
                        <?php include('submenu.php');?>
                         <h3 class="float_left"> Orders Deleted </h3>
                      </div>
            ...
            <table style="background-color:#FFF" class="table table-bordered table-striped table-condensed">
                             <thead>
                              <tr>
                                  ...
                                  <th width="28" >Deleted</th>
                                   <th width="42" >Deleted by</th>
                                  <th width="58" class="numeric">Options</th>
                              </tr>
                             </thead>
                             <tbody>
                            <?php $i=1; $q=mysql_query("SELECT * FROM `tbl_orders` where status=5 order by order_id desc ") or die(mysql_error());
							if(mysql_num_rows($q)==0){ echo '<tr><td colspan=7>List Empty. nice time</td><tr>';}  while($r=mysql_fetch_array($q)){
								?>  <tr>
                                  <td><?php echo $i;?></td>
                                  ...
                                  <td class=""><?php echo date("Y-m-d",strtotime($r['date_supplied']))?></td>
                                  <td style="text-transform:uppercase" ><?php $by= $r['supplied_by']; echo get_name($by);?></td>
