                  ...
                  <div class="col-lg-9 main-chart">
                    ...
                    <div class="border-head">
                      <?php include('submenu.php'); $date=date('Y-m-d'); ?>
                         <h3 class="float_left">Couching Plans</h3>
                    </div>
                 ...
                 <!--   <a data-toggle="modal" class="btn btn-success btn-sm" href="#myModal"> Add Competitor Product</a>-->
                   ...
                   <section id="unseen">
                            ...
                            <table class="table table-bordered table-striped ">
                              <thead>
                              <tr><td >No</td><td>Date</td> <td>Place</td> <td >Justification</td><td >Participants</td> <td >Scheduled by</td> </tr>
                              </thead>
                              <tbody id="couching_plansList">
