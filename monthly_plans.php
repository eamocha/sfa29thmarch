              ...
              <div class="row">
                  <div class="col-lg-9 main-chart">
                      ...
                      <div class="border-head">
                        <?php include('submenu.php'); $date=1; $tsr=1; if(isset($_REQUEST['day']))$date=$_REQUEST['day']; if(isset($_REQUEST['user']))$tsr=$_REQUEST['user'] ?>
                        <h3 class="float_left">Monthly plans per Sales Rep <span  id="img_icons"><img src="assets/img/pdf_icon.gif" onClick="javascript:demoFromHTML()" /> <img onclick="javascript:printDiv('pdfthis')" src="assets/img/print_icon.gif" ><img id="btnExport" src="assets/img/excel_icon.gif"> <img onClick="window.location='inbox.php'" src="assets/img/email_icon.gif"></span></h3>
                      </div>
...
?><form action="<?php $_SERVER['PHP_SELF']?>" method="post"><table ><tr><td>From </td><td> <select class="form-control " id="month" name="month"></select> </td><td>TSR</td><td><select  class="form-control sales_person_selection" name="tsr" id="sales_person_selection"></select></td><td><button class="btn btn-small btn-success" type="submit" name="submit" >Search</button></td></tr></table></form> </div>
 ...
 <!-- js placed at the end of the document so the pages load faster -->
    ...
    $(document).ready(function(e) {
        //load the the data
		var month= <?php echo $date?> ; var tsr= <?php echo $tsr?>;
var url="report_sections/monthly_plans.php?month="+month+"&tsr="+tsr;
	$("#monthly_plans").load(url);
    });
    </script>
