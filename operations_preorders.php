              ...
              <div class="row">
                <div class="col-lg-9 main-chart">
                  ...
                  <table style="background-color:#FFF" class="table table-bordered table-striped table-condensed">
                             ...
                             <tbody>
                            <?php $i=1; $q=mysqli_query($mysqli,"SELECT * FROM `tbl_orders` order by order_id desc") or die(
							mysqli_error($mysqli)); while($r=mysqli_fetch_array($q)){
								?>  <tr>
                                  <td><?php echo $i;?></td>
