...
{?> <div class="room-box notvisited"><?php } ?>
                              ...
                              <p>Located at<?php echo $row['town']." ".$row['place_name']?>. The dealer placed an order on <?php $row['date_time'];?> of <?php echo $row['quantity'];?> Cases and <?php //echo $row['single_bottles'];?>  </p>
 ...
 <?php }//end while
                          ...
                          <div class="room-box notvisited">
                              <h5 class="text-primary"><a href="client_history.php">Outlet D </a>- Assigned by Eric Atinga on 12th dec 2014</h5><span style="float:right">   	<button type="button" onclick="window.location='checkin.php? dealer_id=1'" class="btn btn-danger">CheckIn</button></span>
