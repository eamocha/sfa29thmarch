              ...
              <div class="row">
                  <div class="col-lg-9 main-chart">
                      ...
                      <div class="border-head">
                        ...
                        <h3 class="float_left">Route completion summary
                   ...
                   <section id="unseen">
                            <table id="tblExport"  class="table table-bordered table-striped table-condensed">
                              ...
                              <tr>
                                  ...
                                  <th>Unscheduled Outlet Visits</th>
                                  <th title="% of unscheduled visit vs actual visits">% Unscheduled Visits</th>
                                  <th >Success strike outlets.</th>
                                  <th title="No of outlets sold too divided by actual outlet visited" >% Strike Rate</th>
                                  <th title="Total cases sold divided by total visited">Av sell-out per Outlet </th>
                                  
                                </tr>
                              
                              </thead>
                              <tbody id="content_div">
                             <tr> <td colspan="12">Loading <img src='images/37.gif'></td> </tr>                            </tbody>
...
var url="report_sections/route_completion_summary.php?date="+dat+"&tsr="+tsr;
