              ...
              <div class="row">
                  <div class="col-lg-9 main-chart">
                    ...
                    <div class="border-head">
                     ...
                     <div  style="padding-bottom:20px" class="float_left"><select><option>Channel Type</option></select>
                    </div>
                     <!--start -->      <div></div>     
                   <section id="unseen">
...
$(document).ready(function() {
	...
	loading_data('#results',"data.php?dt="+dt+'&mode=assets',track_load,loading,total_groups,total,pergroup);
