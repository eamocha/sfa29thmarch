...
?><form action="<?php $_SERVER['PHP_SELF']?>" method="post"><table width="577" ><tr>
                     ...
                     <!--start -->      <div>Survey report of  <b> <?php $sttime=strtotime($date); echo date('D dS, M Y', strtotime($date));?></b></div>     
                   <section id="unseen">
	...
	loading_data('#results',"data.php?dt="+dt+'&mode=survey',track_load,loading,total_groups,total,pergroup);
                            ...
                            <table  id="tblExport" width="100%" class="table table-bordered table-striped table-condensed">
                              ...
                              <tr  align="center">
                                  ...
                                  <th>Outside Ads</th>
                                  <th>Inside.Ads</th>
                                  <th>Dealer Greated</th>
                                  <th>Opportunity Areas</th>
                                  <th>Corrective action taken and remarks</th>
                                  <th>Done by</th>
                                  <th>Date time</th>
                              </tr>
                              </thead>
