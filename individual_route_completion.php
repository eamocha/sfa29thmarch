              ...
              <div class="row">
                  <div class="col-lg-9 main-chart">
                      ...
                      <div class="border-head">
                        <?php include('submenu.php'); $date=date("Y-m-d"); $tsr=0; if(isset($_REQUEST['day']))$date=$_REQUEST['day']; if(isset($_REQUEST['user']))$tsr=$_REQUEST['user'] ?>
                        <h3 class="float_left">Route Completion Detailed report per user
                   ...
                   <section id="unseen">
                            <table id="tblExport"  class="table table-bordered table-striped table-condensed">
                              ...
                              <tr>
                                  ...
                                  <th rowspan="2">Time Visted</th>
                                  <th rowspan="2">Last Visit date</th>
                                  <th rowspan="2">Period Between Visits</th>
                                  <th rowspan="2" title="% of unscheduled visit vs actual visits">Unscheduled Outlet Visit</th>
                                  <th colspan="3" >Sell out</th>
                                  <th rowspan="2" title="No of outlets sold too divided by actual outlet visited" >Total sell out</th>
                                </tr>
                              <tr>
                                <th >330ml Bottle</th>
                                <th >500ml Can</th>
                             ...
                             <tr> <td colspan="13">Loading <img src='images/37.gif'></td> </tr>                            </tbody>
...
var url="report_sections/individual_route_completion.php?date="+dat+"&tsr="+tsr;
