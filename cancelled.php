              ...
              <div class="row" id="pdfthis">
                  <div class="col-lg-9 main-chart">
                      ...
                      <div class="border-head " id="dontpdf">
                         ...
                         <h3 class="float_left">My routes plan - <?php echo date_title($today_constant);?> 
                     ...
                     <table  width="100%" ><tr>
                     <td>Planned to Visit</td><td><?php $today=date('Y-m-d',strtotime($today_constant)); echo all_dealers_in_route($user_id,$today);?></td><td>Already Visited </td><td> <?php echo already_visted($user_id,$today) ?></td><td>Canceled</td>
                   ...
                   <section id="pdfthis">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tr>
                                  <th width="20">No</th>
                                  <th width="86"> Outlet Name</th>
                                  <th width="83"> Location</th>
                                  <th width="84">Decision Maker</th>
                                  <th width="52">Contact</th>
                                 <th width="159" class="numeric">Actions</th>
                                 
                              </tr>
                              </thead>
                              <tbody>
                              <?php  today_dealers($user_id,$today);?>
                               </tbody>
                          </table>
                          </section>
