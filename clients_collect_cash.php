                ...
                <div class="col-lg-9 main-chart">
                      ...
                      <div class="border-head">
                        <?php include('submenu.php');?>
                         <h3 class="float_left">Receive cash</h3>
                      </div>
                  ...
                  <table style="background-color:#FFF" class="table table-bordered table-striped table-condensed">
                             <thead><tr> <td  width="8"></td><th width="78">Dealer Name</th> <th width="100">Owner/Contact</th><th width="76" class='hidden-phone'>Town/Place</th><th width="41" class='hidden-phone'>Phone</th> <th width="38" class='hidden-phone'>Email</th><th width="64" class='hidden-phone'>Options</th></tr></thead>
                                
                                  <tbody id="clients_collect_cash"></tbody>
