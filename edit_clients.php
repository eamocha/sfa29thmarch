...
<html lang="en">
  <head>
    ...
    <![endif]--> <?php require 'header.php';  $user_id=$_SESSION['u_id']; $dealer_id=0;
	if(isset($_REQUEST['dealer_id'])){$dealer_id=clean($_REQUEST['dealer_id']);}else{$dealer_id=clean($_REQUEST['cid']);}		
