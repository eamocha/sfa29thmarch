...
?>
                  ...
                  <td >BY</td>
                  <td ><?php echo user_select_list($user_id)?></td>
                  <td >Select Month</td><td ><select class="form-control" name="month" id="month"><option  value="0"> Select Month</option></select></td><td >Select year</td><td width="48"><select  class="form-control" id="year" name="year"><?php echo years_in_orders()?></select></td>
