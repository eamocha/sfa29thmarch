                  ...
                  <div class="col-lg-9 main-chart">
                      ...
                      <div class="border-head">
                        <?php include('submenu.php'); $date=date('Y-m-d'); ?>
                         <h3 class="float_left">Details of already expired ordes</h3>
                      </div>
...
$(document).ready(function() {
	...
	loading_data('#results',"data.php?dt="+dt+'&mode=expired',track_load,loading,total_groups,total,pergroup);
                            ...
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tr>
                                  ...
                                  <th width="106" rowspan="3">Outlet </th>
                                  <th width="107" rowspan="3">Region</th>
                                  <th colspan="4" class="numeric">Soda </th>
                                  <th colspan="2" class="numeric">Dasani </th>
                                  <th colspan="3" class="numeric">Nibute maid</th>
                                <th width="122" rowspan="3" class="numeric">Explanation</th>
                              </tr>
                              <tr>
