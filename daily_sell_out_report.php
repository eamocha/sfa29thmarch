              ...
              <div class="row">
                  <div class="col-lg-9 main-chart">
                      ...
                      <div class="border-head">
                        ...
                        <h3 class="float_left">Daily sell out report: This report capture sell-out to already listed outlets				
                   ...
                   <section id="unseen">
                            <table id="tblExport"  class="table table-bordered table-striped table-condensed">
                              ...
                              <tr>
                                  ...
                                  <th colspan="3">Sell-Out by (AD)</th>
...
var url="report_sections/Daily_Sell_Out_Report.php?date="+dat+"&tsr="+tsr;
