...
<html lang="en">
  <head>
    ...
    <![endif]--> <?php require 'header.php';  $user=$_REQUEST['uid'];?>
...
function init() {
	...
	//alert(user);
    makeRequest('track.php?uid='+user_id, function(data) {
...
$(document).ready(function() {   
      $.ajax({    //create an ajax request to load_page.php
        type: "GET",  url: "fetch_places.php?uid="+user_id,  dataType: "html",   //expect html to be returned                
        success: function(response){                    
            $("#visted").html(response); 
            //alert(response);
        }
    });
	});
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
             ...
             <h3><?php echo get_name($user);?>:  Outlets  visited Today</h3>
